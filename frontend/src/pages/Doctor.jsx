  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        ...
        {/* ✅ Filter options */}
        <div
          className={`flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-4 ${
        ...
        >
          <p
            ...
            className={`w-[95vw] sm:w-auto pl-20 py-1.5 pr-24 border border-gray-300 rounded hover:text-blue-500 transition-all cursor-pointer ${
              speciality === 'All' ? 'bg-indigo-100 text-black' : ''
            }`}
          >
            All
          </p>
          <p
            ...
            className={`w-[95vw] sm:w-auto pl-20 py-1.5 pr-16 border border-gray-300 rounded hover:text-blue-500 transition-all cursor-pointer ${
              speciality === 'General physician'
